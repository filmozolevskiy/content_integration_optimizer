...
explore: content_integration_optimizer_tags_seed {
  hidden: yes
  label: "New Optimizer (tags seed)"
...
explore: content_integration_optimizer {
  ...
  join: tags_agg {
    type: left_outer
    # One row per candidate_id in tags_agg; same grain as optimizer_candidates PK.
