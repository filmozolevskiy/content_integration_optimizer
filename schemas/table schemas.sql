...
CREATE TABLE `optimizer_candidates` (
  ...
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `attempt_id` bigint NOT NULL DEFAULT '0',
  `reprice_type` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `reprice_index` varchar(32) COLLATE utf8mb4_general_ci NOT NULL,
  `rank` int NOT NULL DEFAULT '0',
  `candidacy` enum('Unprocessable','Unbookable','Inadmissible','Unsalable','Incalculable','Unprofitable','Unmatchable','Eligible','Saver') COLLATE utf8mb4_general_ci NOT NULL,
  `gds` varchar(30) COLLATE utf8mb4_general_ci DEFAULT '',
  `gds_account_id` varchar(30) COLLATE utf8mb4_general_ci DEFAULT '',
  `currency` char(3) COLLATE utf8mb4_general_ci DEFAULT '',
  `fare_type` enum('published','private') COLLATE utf8mb4_general_ci DEFAULT 'published',
  `validating_carrier` char(2) COLLATE utf8mb4_general_ci DEFAULT '',
  `pricing_options` varchar(8) COLLATE utf8mb4_general_ci DEFAULT '',
  `flight_numbers` varchar(100) COLLATE utf8mb4_general_ci DEFAULT '',
  `commission_trip_id` bigint DEFAULT NULL,
  `void_rule_id` int DEFAULT NULL,
  `base` decimal(10,2) DEFAULT NULL,
  ...
  `dropnet_revenue` decimal(10,2) DEFAULT NULL,
  `segment_revenue` decimal(10,2) DEFAULT NULL,
  `booking_classes` varchar(20) COLLATE utf8mb4_general_ci DEFAULT '',
  `cabin_codes` varchar(20) COLLATE utf8mb4_general_ci DEFAULT '',
  `fare_bases` varchar(255) COLLATE utf8mb4_general_ci DEFAULT '',
  `fare_families` varchar(255) COLLATE utf8mb4_general_ci DEFAULT '',
  PRIMARY KEY (`id`),
  KEY `parent_id_idx` (`parent_id`),
  KEY `created_at_idx` (`created_at`),
  KEY `gds_office_idx` (`gds`,`gds_account_id`),
  KEY `attempt_id_idx` (`attempt_id`),
  CONSTRAINT `optimizer_candidates_attempt_id_fk` FOREIGN KEY (`attempt_id`) REFERENCES `optimizer_attempts` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=437540813 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci